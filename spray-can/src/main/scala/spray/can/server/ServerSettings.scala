...
object ServerSettings extends SettingsCompanion[ServerSettings]("spray.can.server") {
  ...
  def fromSubConfig(c: Config) = apply(
    ...
    Timeouts(
      ...
      c getScalaDuration "chunkhandler-registration-timeout",
      c getScalaDuration "bind-timeout",
      c getScalaDuration "unbind-timeout",
      c getScalaDuration "registration-timeout",
      c getScalaDuration "parsing-error-abort-timeout"),
